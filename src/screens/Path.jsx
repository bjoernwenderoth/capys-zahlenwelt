...
export default function Path({ profile, muted, lastPlayedLevelId, onStartLevel, onToggleMute, onSwitchProfile }) {
  ...
  useEffect(() => {
    ...
    const focusTimer = window.setTimeout(() => infoCloseRef.current?.focus(), 0)
  ...
  return (
    <div className="screen path-screen" data-accent={profile.accent || 'blue'}>
      ...
      {showInfo && (
        <div className="modal-backdrop info-modal-backdrop" onClick={() => setShowInfo(false)}>
          <div
            ...
            <div className="info-modal-layout">
              ...
              <div className="info-modal-content">
                <header className="info-modal-header">
                  ...
                  <h2 className="modal-title" id="info-modal-title">Capys Zahlenwelt</h2>
                  <p className="info-modal-lead">
                    Eine kleine Lernreise für Kinder, bei der sich Rechnen mehr nach
                    Abenteuer und weniger nach Arbeitsblatt anfühlen soll.
                  </p>
                </header>
