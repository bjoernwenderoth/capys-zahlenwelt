...
export default function App() {
  ...
  // (unsichtbar hinter dem Quiz-Screen, siehe content-visibility in
  // .path-screen.is-hidden) statt komplett neu aufgebaut zu werden. Vorher
  // wurde beim Zurückkehren von JEDEM Quiz-Versuch die komplette
  // Kartendekoration (großes SVG-Panorama) neu gemountet – das war die
  // eigentliche Ursache für das Ruckeln von Capys Lauf-Animation und den
  // spürbaren Nachlade-Moment beim Zurückwechseln zur Karte.
